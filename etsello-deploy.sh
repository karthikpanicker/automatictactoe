...
TRELLO_CONSUMER_SECRET=$TRELLO_CONSUMER_SECRET ETSY_CONSUMER_KEY=$ETSY_CONSUMER_KEY ETSY_CONSUMER_SECRET=$ETSY_CONSUMER_SECRET TRELLO_CONSUMER_KEY=$TRELLO_CONSUMER_KEY docker-compose up -d --force-recreate
}
executor
